...
class Quick_Count_Widget extends WP_Widget {
    ...
    function widget ($args,$instance) {
        ...
        echo $quick_count->show($online_count, $count_each, $most_count, $user_list, $by_country, $visitors_map, 'quick-count-widget');
        echo $after_widget;
    }
    ...
    function form ($instance){
        $defaults = array('title'=> '', 'online_count' => 1, 'count_each' => 1, 'by_country' => 1, 'most_count' => 1 );
