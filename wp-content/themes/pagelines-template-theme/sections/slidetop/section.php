 ...
 * @author PageLines
 */
class slidetop extends PageLinesSection {

	var $taxID = 'slidetop-sets';
	var $ptID = 'slidetop';
...
<?php
	...
	*/
	function post_meta_setup(){
			...
			$pt_panel = array(
					...
					'name' 		=> __( 'Feature Setup Options2', 'pagelines' ),
					'posttype' 	=> $post_types, 
					'hide_tabs'	=> true
				);
	...
	*/
	function post_type_setup(){
			...
			$args = array(
					'label' 			=> __( 'slidetops', 'pagelines' ),  
					'singular_label' 	=> __( 'slidetop', 'pagelines' ),
	...
	function section_optionator( $settings ){
		$settings = wp_parse_args( $settings, $this->optionator_default );
			...
			$page_metatab_array = array(
					'feature_setup' => array(
						'type'		=> 'multi_option', 
						'title'		=> __('Feature Section Setup2', 'pagelines'), 
						'shortexp'	=> __('Basic section setup for features2', 'pagelines'),
						...
						'selectvalues'	=> array(
							...
							'feature_set' => array(
								'version' 		=> 'pro',
								'default'		=> 'default-features2',
								'type' 			=> 'select_taxonomy2',
								'taxonomy_id'	=> $this->taxID,				
								'inputlabel'	=> __( 'Select Feature Set2', 'pagelines' ),
							),
