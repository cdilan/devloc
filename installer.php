...
<div id="content">
	...
	if ($action == 'process') {
		...
		dinstaller_log("secure build name: 503cce583634c4556_20120828_gamecdilan");
		dinstaller_log("----------------------------------");
	...
	<?php if  ($action == null) : ?>
		...
		<form id="form-installer" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" >
			...
			<table width="100%" border="0" cellspacing="2" cellpadding="2" class="table-inputs">
				...
				<tr>
					<td>Site Title</td>
					<td><input type="text" name="site_title" id="site_title" value="Game CDI LAN" /></td>
				</tr>
			</table><br/>
